...
contract NFTMarketplace is ERC721URIStorage {
    ...
    constructor() ERC721("NFT Metaverse Token", "MYNFT") { //name, symbol
    ...
    public 
    payable 
    onlyOwner{ //This function is to update the price of the NFT
    ...
    // FUNCION FOR RESELL TOKEN
    function reSellToken(uint256 tokenId, uint256 price) public payable{
        require(idMarketItem[tokenId].owner == msg.senedr, "Only item owner can pass this operation");
        ...
        idMarketItem[tokenId].owner = payable(address(this)); //Whenever someone resell the nft, NFT will go to the contract and cntract becoming the owner
    ...
    function createaMarketSale(uint256 tokenId) public payable{
        ...
        require(msg.vale == price, "Please submit the require amount of price to complete the purchase ");
